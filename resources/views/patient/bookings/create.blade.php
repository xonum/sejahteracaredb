    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('patient.bookings.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-wrap ">
                                            <div>
                                                <input type="text"
                                                    ...
                                                    name="booking_date" placeholder="" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex flex-wrap ">
                                            <div>
                                                <input type="text" class="form-control jqtimepicker w-fit"
                                                    name="booking_time" placeholder="" required>
                                            </div>
                                        </div>
                                    </div> --}}
                                        <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="booking_time" id="booking_time" required>
                                                        <?php
                                                            for ($hour = 10; $hour < 16; $hour++) {
                                                                for ($minute = 0; $minute < 60; $minute += $settings->time_interval) {
                                                                    $formatted_hour = sprintf('%02d', $hour);
                                                                    $formatted_minute = sprintf('%02d', $minute);
                                                                    printf('<option value="%s:%s">%s:%s</option>', $formatted_hour, $formatted_minute, $formatted_hour, $formatted_minute);
                                                                }
                                                            }
                                                        ?>
                                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <textarea class="form-control w-33" aria-describedby="" id="" name="reason" rows="6"
                                    placeholder="Enter Reason for Booking"></textarea>
                            </div>
                            @error('reason')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
