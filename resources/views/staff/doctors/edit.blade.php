    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('staff.doctors.update', $doctor->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="text" class="form-control w-33" aria-describedby="" id="" required
                                    value="{{$doctor->designation}}" name="designation">
                            </div>
                            @error('designation')
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="text" class="form-control w-33" aria-describedby="" id=""
                                    value="{{$doctor->username}}" name="username">
                            </div>
                            @error('username')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="text" class="form-control w-33" aria-describedby="" id=""
                                    value="{{$doctor->firstname}}" name="firstname">
                            </div>
                            @error('firstname')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="text" class="form-control w-33" aria-describedby="" id=""
                                    value="{{$doctor->lastname}}" name="lastname">
                            </div>
                            @error('lastname')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                    <input type="text" name="phone" class="form-control w-33" pattern="[0-9]*" inputmode="numeric" value="{{$doctor->phone}}" maxlength="12" autocomplete="off" required />
                            </div>
                            @error('phone')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="5" name="address" placeholder="Enter Address">{{$doctor->address}}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">{{ __('Profile Picture') }}</label>
                            <div>
                                <a href="{{$doctor->profile_picture}}" target="_blank"><img class="img-thumbnail" src="{{$doctor->profile_picture ?? URL::to('/').'/assets/images/default-pro.jpg'}}" alt="Profile Picture" class="rounded-full h-20 w-20"></a>
