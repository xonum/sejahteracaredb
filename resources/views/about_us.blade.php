					...
					<div class="col-12">
						<div class="inner-content">
							<div class="image-slider">
									<img src="{{asset('/assets/page/img/clinic-front-staff.jpg')}}" alt="#">
								
							</div>
							<div class="body-text">
								<h3>Our Vision</h3>
								<p>
                                    IIUM Sejahtera Clinic aims at becoming a leading primary health care centre offering execellent health care services to its clients. It is aligned with IIUM's vision of becoming a leading international centre of excellence in education.
                                </p>
                                <h3>Our Mission</h3>
								<ul>
                                    <li>
                                        To develop a comprehensive healthy living environment that includes physical, mental and spiritual health awareness amongst the IIUM community that enable them to enjoy a sustainable quality of life.
                                    </li>
                                    <li>
                                        To instil cognizance among the IIUM Comunity that health as a valuable asset and individual's responsibility.
                                    </li>
                                </ul>
