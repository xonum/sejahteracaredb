<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{asset('assets/images/logo.png')}}" width="64" height="64" alt="Sejahtera" class="">
            </a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3 ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('patient.bookings.index')}}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('patient.bookings.create')}}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link" href="{{route('patient.reports.index')}}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
